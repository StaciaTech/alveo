...
import DonateForm from "@/components/DonateForm"; // Adjust path as needed
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed mb-8 max-w-3xl mx-auto">
                From rural villages to international symposium halls, we are
                laying the foundation for a future where respiratory diseases
                are not a lifelong burden, but a preventable, manageable, and
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  ...
                  className="alveo-gradient text-white hover:opacity-90 transition-opacity"
                >
                  Support Our Mission
                ...
                <Card className="shadow-soft">
                  <CardContent className="p-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      "Promoting Responsible Science and Research for
                      Personalized Good Health Practices"
                    </p>
                  </CardContent>
                </Card>
                <Card className="shadow-soft">
                  <CardContent className="p-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      "To foster respiratory health awareness and build a
                      sustainable, personalized respiratory health ecosystem
                      through continuous research, education, and technology"
                    </p>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                We are not just a health initiative. We are a movement for
                scientific excellence, equitable access, and integrated
                care—built on the firm foundation of 4P medicine.
              </p>
            </div>
              ...
              {[
                {
                  title: "Preventive",
                  description:
                    "Early intervention and disease prevention strategies",
                  icon: "🛡️",
        ...
        <section className="py-16 bg-primary/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Together, we can create a world where lung health is a right—not a
              privilege. Your support enables groundbreaking research, community
              outreach, and innovative solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
      ...
      <Dialog open={isDonateModalOpen} onOpenChange={setIsDonateModalOpen}>
        <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
          <DialogHeader className="sr-only">
            <DialogTitle>Donate to ALVEO 4P</DialogTitle>
          </DialogHeader>
          <DonateForm onSuccess={closeDonateModal} />
        </DialogContent>
      </Dialog>
    </>
  );
